	...
	<form name="form" class="form form-horizontal" id="form-article-add">
		...
		<div class="row cl">
			<div class="col-xs-8 col-sm-9 col-xs-offset-4 col-sm-offset-2">
				<button id="confirmChange" onClick="" class="btn btn-primary radius" type="submit"><i class="Hui-iconfont">&#xe632;</i> 确认修改</button>
				<button id="cancel" onClick="" class="btn btn-default radius" type="submit">&nbsp;&nbsp;取消&nbsp;&nbsp;</button>
			</div>
		</div>
	</form>
</article>
...
document.getElementById("confirmChange").onclick = function(){
	...
	//alert(pageCurrent);
	document.form.action="${pageContext.request.contextPath}/bAppeal/updateProject.action?id="+id+"&pageCurrent="+pageCurrent;
...
document.getElementById("cancel").onclick = function(){
	var pageCurrent = ${pageCurrent};
	//alert(pageCurrent);
	document.form.action="${pageContext.request.contextPath}/bAppeal/getAllProjectAppeals.action?pageCurrent="+pageCurrent;
	document.form.submit();
}
</script>
