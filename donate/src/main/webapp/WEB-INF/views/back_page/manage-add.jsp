...
<script type="text/javascript">
	function Pwd(){
		 var pwd = document.getElementById("psw");
			...
			alert("密码少于8位重新输入！");
			setTimeout(function(){pwd.focus();},0);//让元素先失去焦点再获取焦点，0为时间
			//document.getElementById("psw").focus();//通常按此方法，但火狐浏览器此方法失效
			return;
			} 
	}
...
<script type="text/javascript">
	function Confirm(){
		...
		pwd1=document.getElementById("psw1").value;
		
		if(!(pwd==pwd1 && pwd1!='')){
			alert("两次输入的密码不一致，请重新输入！");
			setTimeout(function(){pwd1.focus();},0);//让元素先失去焦点再获取焦点，0为时间
			return;
		}
	}
</script> 
...
<script type="text/javascript">
	function Click(){
		...
		c2=document.getElementById("sex").value;
		c3=document.getElementById("email").value;
		c4=document.getElementById("countSate").value;
		c5=document.getElementById("countType").value;
		c6=document.getElementById("createDate").value;
...
<article class="page-container">
	<form class="form form-horizontal"  action="<%=path%>/manage/addManage" method="post">
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>用户名：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="zcl" placeholder="" id="userName" name="userName">
			</div>
		</div>
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" onblur="Pwd();" value="" placeholder="" id="psw" name="password">
			</div>
		</div>
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" onblur="Confirm();" placeholder="" id="psw1" name="password1">
			</div>
		</div>
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="1" placeholder="" id="sex" name="sex">
			</div>
		</div>	  
	 	...
	 	<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="100000@qq.com" placeholder="" id="email" name="email">
			</div>
		</div>
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="1" placeholder="" id="countState" name="countState">
			</div>
		</div>
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="1" placeholder="" id="countType" name="countType">
			</div>
		</div>
		
		
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>创建日期：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="2016-09-20" placeholder="" id="createDate" name="createDate" 
				onfocus="WdatePicker({Date:'#F{$dp.$D(\'logmax\')||\'%y-%M-%d\'}'})" style="width:120px;" >
			</div>
		</div>
		...
		<div class="row cl">
			<div class="col-xs-8 col-sm-9 col-xs-offset-4 col-sm-offset-2">
				<button onClick="article_save_submit();" class="btn btn-primary radius" onblur="Click();" type="submit" >
				<i class="Hui-iconfont">&#xe632;</i> 确认</button>
