	...
	<form class="form form-horizontal" id="form-article-add">
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="${user.userName }" placeholder="" id="" name="">
			</div>
		</div>
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="${user.realName }" placeholder="" id="" name="">
			</div>
		</div>
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<c:if test="${user.sex == 0 }">
					<input type="text" class="input-text" value="男" placeholder="" id="" name="">
				</c:if>
				<c:if test="${user.sex == 1 }">
					<input type="text" class="input-text" value="女" placeholder="" id="" name="">
				</c:if>
			</div>
		</div>
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="${user.idCard }" placeholder="" id="" name="">
			</div>
		</div>
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="${user.tel }" placeholder="" id="" name="">
			</div>
		</div>
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="${user.email }" placeholder="" id="" name="">
			</div>
		</div>
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="${user.address }" placeholder="" id="" name="">
			</div>
		</div>
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<c:if test="${user.countType == 0 }">
					<input type="text" class="input-text" value="会员" placeholder="" id="" name="">
				</c:if>
				<c:if test="${user.countType == 1 }">
					<input type="text" class="input-text" value="管理员" placeholder="" id="" name="">
				</c:if>
				<c:if test="${user.countType == 2 }">
					<input type="text" class="input-text" value="系统管理员" placeholder="" id="" name="">
				</c:if>
			</div>
		</div>
