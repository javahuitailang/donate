...
<link rel="stylesheet" type="text/css" href="<%=path%>/style/jquery1.4.js">
...
<link type="text/css" rel="stylesheet" href="<%=path%>/style/pay.css" />
...
<body>
	...
	<div class="divContent">
			<span class="spanPrice">项目：</span><span class="spanPrice">${appealId }</span>
			<span class="spanPrice">支付金额：</span><span class="price_t">&yen;${price_t }元</span><br>
	</div>
	<form action="<%=basePath%>record/payment" method="post" id="form1" target="_bank">
		<input type="hidden" name="appealId" value="${appealId }" />
		<input type="hidden" name="price_t" value="${price_t }" />
		<div class="divBank">
