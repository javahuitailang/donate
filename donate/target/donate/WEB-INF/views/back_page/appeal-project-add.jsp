...
<article class="page-container">
	<form name="form" class="form form-horizontal" id="form-article-add">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="" placeholder="" id="" name="goalMoney">
			</div>
		</div>
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="10" placeholder="" id="" name="sortNum">
			</div>
		</div>
			...
			<div class="formControls col-xs-8 col-sm-9"> 
				...
				<table cellspacing="1" cellpadding="2" width="100%" border="0" class="pn-ftable">
						<tbody id="tab_1">
								<tr>
										<td >
											<textarea  style="width:100%;height:400px;"id="helpdesc" name="content"
...
<!-- 				屏蔽自带fck -->
		...
		<div class="row cl">
			<div class="col-xs-8 col-sm-9 col-xs-offset-4 col-sm-offset-2">
				<button id="saveAndSubmit" class="btn btn-primary radius" type="submit"><i class="Hui-iconfont">&#xe632;</i> 保存并提交</button>
...
<script type="text/javascript">
	//保存并提交
	document.getElementById("saveAndSubmit").onclick = function(){
		alert("xxx");
		document.form.action="${pageContext.request.contextPath}/bAppeal/addProject.action";
	...
	document.getElementById("back").onclick = function(){
		alert("xxx2");
		document.form.action="${pageContext.request.contextPath}/bApply/getAllApplys.action";
		document.form.submit();
	}
